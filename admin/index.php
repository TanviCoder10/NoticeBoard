      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="#"><img src="../images/images.png" width="100" height="100" alt="not found"/></a></li>
		...
		@$page=  $_GET['page'];
          ...
          <div class="row placeholders">
            <div class="col-xs-6 col-sm-3 placeholder">
              ...
              <h4>Mars Club</h4>
              <span class="text-muted">AR/VR Innovation</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>App Club</h4>
              <span class="text-muted">App Development</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>Pixinsight</h4>
              <span class="text-muted">Coding and Creativity</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>Tesa</h4>
              <span class="text-muted">Electronics and Robotics</span>
            </div>
          </div>
